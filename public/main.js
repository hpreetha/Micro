...
window.require.define({"controllers/MyController": function(exports, require, module) {
...
window.require.define({"main": function(exports, require, module) {
  tuiForms={};
  tuiForms.controllers={};
  tuiForms.controllers.MyController = require('controllers/MyController');
  tuiForms.MyController = new tuiForms.controllers.MyController();
}});

window.require.define({"metadata/air": function(exports, require, module) {
  module.exports = {
...
window.require.define({"models/MyModel": function(exports, require, module) {
